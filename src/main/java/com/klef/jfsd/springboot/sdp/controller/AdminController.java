...
public class AdminController {
	...
	public ModelAndView addFund(HttpServletRequest request, @RequestParam("fundImage") MultipartFile file) {
	    ...
	    if (!file.isEmpty() && (file.getContentType().equals("image/jpeg") || file.getContentType().equals("image/png"))) {
	        try {
	            // Define the upload directory within the webapp folder
	            ...
	            // Save the file and set the relative path
	            String fileName = file.getOriginalFilename();
	            String filePath = uploadDir + File.separator + fileName;
	            file.transferTo(new File(filePath));
	            
	            // Set the relative path (e.g., "fundImages/growwlogo.png")
	    ...
	    // Add the fund through the service
	...
	public ModelAndView updateFund() {
		ModelAndView mv=new ModelAndView();
